        ...
        <div className="h-screen container mx-auto flex  items-center justify-center text-white">
          ...
          <header className="absolute top-0 left-0 w-full flex justify-between items-center p-5  ">
            ...
            <div className="flex items-center space-x-4">
              <Link
                to={"/login"}
               className="bg-purple-700 text-white px-3 py-2  md:px-6 md:py-3 font-bold  rounded-2xl  hover:bg-purple-500">
                Login
              </Link>
              <Link
                to={"/courses"}
                 className="bg-green-600 text-white px-1 py-2  sm:font-semibold md:px-6 md:py-3 md:font-bold  rounded-2xl  hover:bg-green-700" 
              >
                Join now
              </Link>
            </div>
          ...
          <div className="bg-gray-900 p-6  rounded-lg shadow-lg w-[500px] m-6 md:m-0 mt-20">
            ...
            <form onSubmit={handleSubmit} >
              <div className="mb-2">
                <label htmlFor="firstname" className=" text-gray-400 mb-1">
                  Firstname
                </label>
                <input
                  type="text"
              ...
              <div className="mb-2">
                <label htmlFor="lastname" className=" text-gray-400 mb-1">
                  Lastname
                </label>
                <input
                  type="text"
